...
public:
   ...
   * #member ##
   *
   * This is convenient shorthand for a call to `Instance::get_function`
   * followed by an invocation of the resulting `Function` object with some
   * arguments. The template argument ``R``, which must be supplied, corresponds
   * to the result type of the function called ``name``; ``Args...`` corresponds
   * to its argument types.
   *
   ...
   * #member
   *
   * This convenience function is equivalent to calling `Program::get_functions`
   ...
   * #member
   *
   * This convenience function is equivalent to calling `Program::get_globals`
   * on the `Program` this `Instance` was compiled from.
   */
